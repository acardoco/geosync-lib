...
public class JdbcPostgresUpdate {
	...
	public void actualizarEnBD(List<FiltroNumerico> filtrosN, List<AtributoTransformacion> atributosTransformacion,
	...
	private void actualizarAtributos(List<FiltroNumerico> filtrosN, Map<String, Element> osmMapeado,
