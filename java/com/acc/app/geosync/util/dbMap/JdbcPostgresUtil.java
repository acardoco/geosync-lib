...
public class JdbcPostgresUtil {
	...
	public static String resultSetToJson(ResultSet rs, List<AtributoBD> atributos) throws SQLException {
		String result = "{\"type\": \"Feature\",\"properties\":{";
		String propiedades = "";

		try {

			result = result + obtenerPropiedadesToJSON(rs, atributos);
	...
	public static String obtenerPropiedadesToJSON(ResultSet rs, List<AtributoBD> atributos) throws SQLException {
		String result = "";
		String pre = "";
